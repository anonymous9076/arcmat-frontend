    ...
    return (
        <RoleGuard allowedRoles={['admin']}>
            <Container className="py-8">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Manage promotional banners and dynamic bento grid content for your website.
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-2 bg-gray-100 p-1 rounded-xl">
                        <button
                            ...
                            className={`px-4 py-2 text-sm font-semibold rounded-lg transition-all ${activeTab === 'banners' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                                }`}
                        >
                            Banners
                        </button>
                        <button
                            ...
                            className={`px-4 py-2 text-sm font-semibold rounded-lg transition-all ${activeTab === 'bento' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                                }`}
                        >
                            Bento Grid
                        </button>
                ...
                {activeTab === 'banners' ? (
                    <>
                        <div className="flex flex-col sm:flex-row items-center justify-end mb-6 gap-3 w-full">
                            ...
                            <Button
                                ...
                                className="flex items-center bg-[#d9a88a] text-white cursor-pointer hover:bg-white hover:text-[#d9a88a] border border-[#d9a88a] font-bold py-2.5 px-6 rounded-xl transition-all shadow-lg w-full sm:w-auto"
                            >
